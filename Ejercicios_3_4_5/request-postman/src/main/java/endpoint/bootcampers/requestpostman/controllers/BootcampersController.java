package endpoint.bootcampers.requestpostman.controllers;

import endpoint.bootcampers.requestpostman.models.Bootcamper;
import endpoint.bootcampers.requestpostman.services.BootcamperService;
...
public class BootcampersController {
    ...
    public Response meterBootcamper(Bootcamper bootcamper) {
        ...
        System.out.println("/bootcampers/" + bootcamper.getNombre());
